...
//     $item_output .= $args->link_before . '<h3>' . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after;
//     $item_output .= '</h3><p class="sub">' .($item->description==''? trim( wp_trim_words(wp_html_excerpt( strip_shortcodes(get_post($item->object_id)->post_content)),20,'...')):$item->description). '</p>';
//     $item_output .= '</a>';
//     $item_output .= $args->after;
//
//
